...
\begin{figure}
  ...
  \begin{minipage}[c]{.5\textwidth}
    ...
    \begin{cxt}%
     ...
     \att{2}%
     \att{5}%
      \obj{.....}{\tikzmarknode{so7}{7}}
      \obj{.....}{\tikzmarknode{so4}{4}}
      \obj{.....}{\tikzmarknode{so6}{6}}
      \obj{x.x..}{\tikzmarknode{so1}{1}}
      \obj{....x}{\tikzmarknode{so3}{3}}
      \obj{.x.x.}{\tikzmarknode{so2}{2}}
      \obj{.....}{\tikzmarknode{so9}{9}}
      \obj{.....}{\tikzmarknode{so5}{5}}
      \obj{.....}{\tikzmarknode{so8}{8}}
    \end{cxt}
  \end{minipage}%
\end{figure}
