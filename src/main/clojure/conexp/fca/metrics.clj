...
(ns conexp.fca.metrics
  (:require [clojure.core.reducers :as r]
            ...
            [conexp.fca
             ...
             [lattices :refer [inf sup lattice-base-set make-lattice make-lattice-nc 
                               concept-lattice lattice-order extract-context-from-bv
                               distributive?]]]
            [clojure.set :as set]
...
(defn generate-from-triple [triple lat]
  ...
  (let [stage1-meets (for [a triple b triple] (inf lat a b))
        ...
        final-meet (inf lat stage1-joins)

        ground-set (set/union stage1-meets 
                              stage1-joins
                              stage2-meets
                              stage2-joins
                              final-meet)
