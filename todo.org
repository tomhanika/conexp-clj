...
** TODO Make conexp-clj.sh script more sophisticated                 :Daniel:
   For example, it would be nice if we could execute scripts given as
   arguments.
* For 0.0.6-alpha
...
** DONE Improve test coverage of conexp core [5/5]                   :Daniel:
   ...
   - [X] conexp.layouts [6/6]
     ...
     - [X] force
     - [X] freese
** INPROGRESS Add more example files [3/5]                        :Sebastian:
   - [X] basic usage
